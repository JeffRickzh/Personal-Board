...
Afterwards I realized it could be helpful to look at the problem from this direction. If you have a list of all the things you shouldn’t do, you can turn that into a recipe for succeeding just by negating. And this form of list may be more useful in practice. It’s easier to catch yourself doing something you shouldn’t than always to remember to do something you should. [220]
...
Companies of all sizes have a hard time getting software done. It’s intrinsic to the medium; software is always 85% done. It takes an effort of will to push through this and get something released to users. [222]
...
So if you take money from investors, you have to take enough to get to the next step, whatever that is. [224] Fortunately you have some control over both how much you spend and what the next step is. We advise startups to set both low, initially: spend practically nothing, and make your initial goal simply to build a solid prototype. This gives you maximum flexibility.
...
Yes and no. The problem is not so much the money itself as what comes with it. As one VC who spoke at Y Combinator said, “Once you take several million dollars of my money, the clock is ticking.” If VCs fund you, they’re not going to let you just put the money in the bank and keep operating as two guys living on ramen. They want that money to go to work. [225] At the very least you’ll move into proper office space and hire more people. That will change the atmosphere, and not entirely for the better. Now most of your people will be employees rather than founders. They won’t be as committed; they’ll need to be told what to do; they’ll start to engage in office politics.
